...
3. Download the file ending with `.dmg` or `.pkg`. This is the installer for Helix.

---

## 💾 Installation Steps

1. Once the installer file downloads, open it by double-clicking.

2. A new window should appear with the Helix logo and an icon to drag into the Applications folder. Follow the prompts exactly.

3. If prompted, enter your Mac's administrator password.

4. After the installation finishes, go to your Applications folder and find the Helix app.

5. Double-click Helix to open it.

---

## 🎙️ Using Helix for the First Time
...
1. Open Helix.  
2. Look for the settings or menu icon.  
